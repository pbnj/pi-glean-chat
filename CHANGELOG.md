...
## [1.7.0](https://github.com/pbnj/pi-glean-chat/compare/v1.6.0...v1.7.0) (2026-09-15)
...
* read Glean backend URL from models.json ([#5](https://github.com/pbnj/pi-glean-chat/issues/5)) ([7600b4d](https://github.com/pbnj/pi-glean-chat/commit/7600b4d84d1f4c19ba63aaa531d376673295108a))

## [Unreleased]

### Fixed

- Read `providers.glean.baseUrl` from `~/.pi/agent/models.json` when no backend
  URL is supplied through the environment or Glean's auth entry, so the model,
  tool, command, and OAuth surfaces use the configured tenant consistently.
